...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page" version="2.0"
  ...
  <html lang="${language}">
    <head>
      ...
      <script src="controllers/foradmin.js?v=3.0.2">
        <!--script-->
      </script>
      ...
      <script src="controllers/imgs.js?v=3.0.1">
        <!--script-->
      </script>
    ...
    <body>
      <header id="main">
        ...
        <nav aria-label="Създаване на тагове">
          ...
          <ul>
            <li>
              <admin:menuItem label="Игри" url="games" icon="delapouite,joystick" />
            </li>
            <li>
              <admin:menuItem label="Кино и Телевизия" url="movies" icon="delapouite,clapperboard" />
            </li>
            <li>
              <admin:menuItem label="Музика" url="music" icon="lorc,music-spell" />
            </li>
            <li>
              <admin:menuItem label="Книги" url="books" icon="delapouite,bookshelf" />
            </li>
            <li>
              <admin:menuItem label="Настолни Игри" url="boards" icon="lorc,dragon-head" />
            </li>
          </ul>
        </nav>
        <nav aria-label="Добавяне на информация">
          ...
          <ul>
            <li>
              <admin:menuItem label="Новини и Статии" url="article" icon="lorc,papers" />
            </li>
            <li>
              <admin:menuItem label="Картинки" url="images" icon="delapouite,photo-camera" />
            </li>
            <li>
              <admin:menuItem label="Каре" url="aside" icon="lorc,checkbox-tree"/>
            </li>
            <li>
              <admin:menuItem label="Реклама" url="advert" icon="delapouite,piggy-bank" />
            </li>
            <li>
              <admin:menuItem label="Цитати и факти" url="quote" icon="lorc,conversation" />
            </li>
            <li>
              <admin:menuItem label="Автор" url="author" icon="lorc,fountain-pen" />
            </li>
            <li>
              <admin:menuItem label="Брой" url="issue" icon="delapouite,calendar" />
            </li>
            <li>
              <admin:menuItem label="Карта на сайта" url="sitemap" icon="lorc,treasure-map" />
            </li>
          </ul>
        </nav>
      ...
      <footer>
        <p>&amp;copy; Copyright 2015
          <a href="http://forplay.bg/articles/games/news/18/castle-design">Castle Design Ltd.</a>
        </p>
